...
# HEADER
th.hero(
    "The Sovereign Obligation OS",
    "Mandate",
    "It reads a legal document, computes the real deadline under the "
    "law, drafts a response — and asks a human to approve.",
    "PT · EU · ES rule-packs · 54 hand-verified cases · 291 tests · "
    "every number regenerated by CI",
)
